  ...
  const steps = [
    {
      ...
      content: (
        <div className="space-y-6">
          ...
          {/* SOM Grid visualization for kohonen-1 */}
          {lessonId === 'kohonen-1' && (
            <div className="bg-teal-50 border-l-4 border-teal-500 rounded-lg p-6 space-y-4">
              ...
              <p className="text-sm text-teal-700">Each hexagon represents a neuron. After training, similar inputs activate nearby neurons, forming a topology-preserving map.</p>
              ...
              <p className="text-xs text-teal-600 text-center">💡 Tip: Neurons that activate for similar inputs tend to be close together on the map.</p>
            </div>
          )}
        </div>
      ),
